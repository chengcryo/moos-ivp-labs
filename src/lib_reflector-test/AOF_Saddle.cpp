...
AOF_Saddle::AOF_Saddle(IvPDomain g_domain) : AOF(g_domain)
{
...
bool AOF_Saddle::setParam(const string& param, double param_val)
{
  if(param == "osy") {
    m_osy = param_val;
    m_osy_set = true;
...
double AOF_Saddle::evalPoint(const vector<double>& point) const
{
